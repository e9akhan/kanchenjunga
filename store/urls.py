...
urlpatterns = [
    ...
    path(
        "update-equipment/<str:equipment_type>/<int:pk>/", UpdateEquipment.as_view(), name="update-equipment"
    ),
    path(
        "delete-equipment/<str:equipment_type>/<int:pk>/", DeleteEquipment.as_view(), name="delete-equipment"
    ),
    path(
        'detail-equipment/<str:equipment_type>/<int:pk>/', DetailEquipment.as_view(), name='detail-equipment'
    ),
    path(
    ...
    path("search-equipment/<str:equipment_type>/", SearchEquipment.as_view(), name="search-equipment"),
    path(
